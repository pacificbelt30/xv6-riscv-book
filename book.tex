...
\usepackage[driver=dvipdfmx,truedimen,margin=0cm]{geometry}
...
\title{\textbf{xv6: シンプルで Unix 風な\\教育用オペレーティングシステム}}
\author{Russ Cox \hspace{3em} Frans Kaashoek \hspace{3em} Robert Morris\\ \vspace{1em} \\菅原 健（訳）}
